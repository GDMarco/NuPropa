...
class NeutrinoAntineutrinoSecondariesDistribution {
    ...
    explicit NeutrinoAntineutrinoSecondariesDistribution(const std::string& variable_) : variable(variable_) {
...
private:
    ...
    mutable NeutrinoAntineutrinoSecondariesDistribution secondariesDistribution;
...
public:
    ...
    std::vector<int> getProductsChannelId(std::string& filename);
    bool isQuark(int pdgId) const;
    ...
    void performInteraction(Candidate *candidate, double mass, int IDbkg,
